...
```csharp
public class Label : FrinkyEngine.Core.CanvasUI.Panel
```

Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [Panel](./frinkyengine.core.canvasui.panel) → [Label](./frinkyengine.core.canvasui.panels.label)<br>
