...
```csharp
public struct DynamicCharacterMotionConstraint
```

Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [ValueType](https://docs.microsoft.com/en-us/dotnet/api/system.valuetype) → [DynamicCharacterMotionConstraint](./frinkyengine.core.physics.characters.dynamiccharactermotionconstraint)<br>
Implements ITwoBodyConstraintDescription&lt;DynamicCharacterMotionConstraint&gt;, IConstraintDescription&lt;DynamicCharacterMotionConstraint&gt;
...
### **OffsetFromSupportToSupportPoint**
...
### **BuildDescription(TypeBatch&, Int32, Int32, DynamicCharacterMotionConstraint&)**

```csharp
void BuildDescription(TypeBatch& batch, int bundleIndex, int innerIndex, DynamicCharacterMotionConstraint& description)
```
...
`description` [DynamicCharacterMotionConstraint&](./frinkyengine.core.physics.characters.dynamiccharactermotionconstraint&)<br>
