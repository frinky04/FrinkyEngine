...
```csharp
public class TextEntry : FrinkyEngine.Core.CanvasUI.Panel
```

Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [Panel](./frinkyengine.core.canvasui.panel) → [TextEntry](./frinkyengine.core.canvasui.panels.textentry)<br>
