...
```csharp
public class Image : FrinkyEngine.Core.CanvasUI.Panel
```

Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [Panel](./frinkyengine.core.canvasui.panel) → [Image](./frinkyengine.core.canvasui.panels.image)
...
```csharp
public Nullable<Texture2D> Texture { get; set; }
```
