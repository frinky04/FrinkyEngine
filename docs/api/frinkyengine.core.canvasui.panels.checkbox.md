...
```csharp
public class Checkbox : FrinkyEngine.Core.CanvasUI.Panel
```

Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [Panel](./frinkyengine.core.canvasui.panel) → [Checkbox](./frinkyengine.core.canvasui.panels.checkbox)<br>
