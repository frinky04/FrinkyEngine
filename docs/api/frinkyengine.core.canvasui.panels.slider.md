...
```csharp
public class Slider : FrinkyEngine.Core.CanvasUI.Panel
```

Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [Panel](./frinkyengine.core.canvasui.panel) → [Slider](./frinkyengine.core.canvasui.panels.slider)<br>
