...
```csharp
public class ScrollPanel : FrinkyEngine.Core.CanvasUI.Panel
```

Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [Panel](./frinkyengine.core.canvasui.panel) → [ScrollPanel](./frinkyengine.core.canvasui.panels.scrollpanel)
