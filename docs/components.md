...
| `SkinnedMeshAnimatorComponent` | `AnimationSources` (list of .glb asset paths for multi-source animation loading), `PlayAutomatically` (true), `Loop` (true), `PlaybackSpeed` (1.0), `ClipIndex` (0), `Playing` (true) |
